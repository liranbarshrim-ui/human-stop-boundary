...
NAV = '''<header class="site-upgrade-bar" {marker}><div class="mu-inner"><a class="mu-brand" href="{root}"><span class="mu-dot"></span>MATRIX AUDIT</a><nav class="mu-links"><a href="{root}">Question</a><a href="{root}dar.html">DAR</a><a href="{root}case-studies.html">Evidence</a><a href="{root}break-it.html">Break It</a><a href="{root}review.html">Private Review</a><a class="mu-cta" href="{root}break-it.html">TEST THE BOUNDARY →</a></nav></div></header><div class="site-upgrade-status"><strong>A11 STATUS:</strong> independent runtime/interface audit pending · the project does not claim a PASS before independent evidence</div>'''

PANEL = '''<section class="site-upgrade-shell" aria-label="Independent adversarial review"><div class="site-upgrade-panel"><div class="kicker">Independent verification</div><h2>Do not trust the boundary. Try to break it.</h2><p>Matrix Audit is seeking independent security researchers to test the declared boundary against alternate execution paths. The audit is intentionally falsifiable: a reproducible bypass is a finding, not a failure of the research process.</p><div class="mu-actions"><a class="mu-button primary" href="{root}break-it.html">Open the A11 challenge →</a><a class="mu-button" href="https://github.com/liranbarshrim-ui/human-stop-boundary/issues/12">GitHub challenge →</a></div><div class="mu-evidence-grid"><article><b>V1–V3</b><strong>Identity · IPC · processes</strong><span>Try alternate identities, transports, helpers and child-process paths.</span></article><article><b>V4–V6</b><strong>Interfaces · recovery · TOCTOU</strong><span>Look for direct adapters, recovery bypasses, descriptor substitution and races.</span></article><article><b>V7–V8</b><strong>Side channels · rollback</strong><span>Test network/plugin routes and attempts to restore state before a fresh protected commit.</span></article></div></div></section>'''
