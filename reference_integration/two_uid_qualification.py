...
def main():
    ...
    try:
        ...
        refused={"deployment_id":refused_id,"artifact_digest":digest,"artifact_b64":enc,"fence_epoch":0,"idempotency_key":"refuse-1","expires_at":int(time.time())+300,"refusal_id":"ref-1","effect_id":effect_id,"capability_txid":"cap-1","issued_at":int(time.time())}; rf=td/"refuse.json"; rf.write_text(json.dumps(refused)); os.chmod(rf,0o644)
